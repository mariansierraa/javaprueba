...
public class QuotesDelta implements CustomModule, BarDataListener, DepthDataListener, SnapshotEndListener {
    ...
    private boolean snapshotCompleted = false; #se supone que se hace solo

    private Indicator line1;

    #esto de abajo va en la primera funcionn
    @Override
...
#voy aqui 
    ...
    public void onDepth(boolean isBid, int price, int size) { #esto mismo va en la funcion de python
